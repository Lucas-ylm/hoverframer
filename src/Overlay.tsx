...
interface ListProps {
  ...
  open: boolean; // Indicates if the list is open
}

function List({ children, open }: ListProps) {
  return (
      ...
      <div className="info">
        ...
        <List open={state.open}>
          ...
          <p>
            ...
            returns with new innovations that make it more itself than ever. Meet the reliable, comfortable, always
